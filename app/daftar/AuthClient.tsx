    ...
    <main className="auth-main">
      ...
      <section className="auth-page shell">
        <div className="auth-context">
          ...
          <div className="auth-points"><span>{dealCount === null ? "Deal terkurasi" : `${dealCount} deal terkurasi`}</span><span>Extra rate khusus member</span><span>Gratis untuk creator Haluan</span></div>
        </div>
        ...
        <div className="auth-card">
          ...
          <form className="auth-form" onSubmit={submit}>
            ...
            <button className="auth-submit" type="submit" disabled={busy}>{busy ? "Memproses…" : mode === "register" ? "Buat akun" : mode === "login" ? "Masuk creator" : mode === "verify" ? "Verifikasi email" : mode === "forgot" ? "Kirim kode reset" : "Simpan kata sandi baru"}<span>↗</span></button>
          </form>
