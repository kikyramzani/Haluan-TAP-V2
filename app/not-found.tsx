...
export default function NotFound() {
  return <main className="system-state"><Link className="brand" href="/"><Image src="/haluan-logo.png" alt="Haluan Digital Network" width={107} height={35}/><span className="brand-divider"/><strong>TAP</strong></Link><span>404 · LOST SIGNAL</span><h1>Halaman tidak ditemukan.</h1><p>Link yang kamu buka mungkin sudah berpindah atau campaign-nya tidak tersedia.</p><div><Link href="/deals">Lihat deal aktif</Link><Link href="/">Kembali ke home</Link></div></main>;
}
